...
\input{capitoli/sistemi_operativi/domande_ed_esercizi_so.tex}

% Capitolo 2: Basi di Dati
\include{capitoli/basi_di_dati/riassunto_basi_di_dati}
\input{capitoli/basi_di_dati/domande_ed_esercizi_bd.tex} % Abilitare quando avrai le domande/esercizi per Basi di Dati

% Capitolo 3: Reti di Calcolatori
\include{capitoli/reti_di_calcolatori/riassunto_reti_di_calcolatori}
\input{capitoli/reti_di_calcolatori/domande_ed_esercizi_reti.tex} % Abilitare quando avrai le domande/esercizi per Reti
